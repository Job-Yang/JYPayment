...
@protocol ZBWeChatPayManagerDelegate <NSObject>
/**
 微信支付成功
 */
 ...
 */
@interface ZBWeChatPayManager : NSObject
/**
 代理
 */
@property (weak, nonatomic) id<ZBWeChatPayManagerDelegate> delegate;
